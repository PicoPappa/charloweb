...
export function ContactFormFunctionMailChimp ()
{
  ...
  return (
    <>
      <ContactForm
        action="https://charlo.us1.list-manage.com/subscribe/post?u=cc5d3e4e1a5ff25633dd282dd&amp;id=c689b3896e"
        method="post"
        ...
        <OfferContainer>
                        ...
                        <ContactLabel for="mce-FNAME" type="text" value="" name="LNAME" class="" id="mce-LNAME">NOME</ContactLabel>
                        <ContactInput type="text" name="user_name" placeholder="Escreva o seu nome aqui"/>
                        <ContactLabel for="mce-EMAIL">EMAIL</ContactLabel>
        <ContactInput type="email" name="EMAIL" class="required email" id="mce-EMAIL" placeholder="Escreva o seu email aqui" />
...
export function PricingCarouselBr ()
{
  ...
  return (
    <>
      <ContactFormFunctionMailChimp></ContactFormFunctionMailChimp>
      <div class="container">
